      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-12">
        ...
        <div className="grid grid-cols-2 gap-8 md:flex md:space-x-12 mb-10 sm:mb-16 border-t border-secondary/50 pt-8">
          ...
          <div className="flex flex-col space-y-2.5 sm:space-y-3">
            ...
            <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="text-offwhite/65 hover:text-offwhite transition-colors text-xs sm:text-sm">WhatsApp</a>
